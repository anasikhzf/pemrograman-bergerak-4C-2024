...
class MainActivity : AppCompatActivity() {
    ...
    //mendeklarasikan variabel aapViewModel sebagai kontenViewModel
    ...
    //menjalankan logika awal saat aktivitas dibuat
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)

        //menginisialisasi aapViewModel dengan parameter yang diperlukan oleh ViewModel

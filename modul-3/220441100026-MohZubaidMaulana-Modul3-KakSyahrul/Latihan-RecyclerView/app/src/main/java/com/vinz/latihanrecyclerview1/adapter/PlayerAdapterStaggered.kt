...
class PlayerAdapterStaggered(private val playerList: List<PlayerData>) : RecyclerView.Adapter<PlayerAdapterStaggered.PlayerViewHolder>() {
    ...
    // Kelas ViewHolder untuk menyimpan referensi view yang digunakan untuk menampilkan data pemain. Setiap item memiliki playerName, playerDescription, dan playerImage.

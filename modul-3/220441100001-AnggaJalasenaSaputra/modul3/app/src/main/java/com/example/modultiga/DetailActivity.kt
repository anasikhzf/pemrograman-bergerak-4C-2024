...
class DetailActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val Name = findViewById<MaterialTextView>(R.id.textView13)
        val Description = findViewById<MaterialTextView>(R.id.textView14)
        val Image = findViewById<ShapeableImageView>(R.id.imageView5)

package com.vinz.modul3.adapter
...
class Adapter(private val playerList: List<Data>) : RecyclerView.Adapter<Adapter.PlayerViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_vertikal, parent, false)

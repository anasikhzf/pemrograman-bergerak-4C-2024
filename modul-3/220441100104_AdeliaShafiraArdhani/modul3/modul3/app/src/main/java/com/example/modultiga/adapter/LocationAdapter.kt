...
class LocationAdapter(private val locationList: List<LocationData>) : RecyclerView.Adapter<LocationAdapter.PlayerViewHolder>() {
    ...
    class PlayerViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        val Name: MaterialTextView = itemView.findViewById(R.id.materialTextView)
        val Lokasi: MaterialTextView = itemView.findViewById(R.id.korsel)
        val NameImage: ShapeableImageView = itemView.findViewById(R.id.seoulpict)
    }

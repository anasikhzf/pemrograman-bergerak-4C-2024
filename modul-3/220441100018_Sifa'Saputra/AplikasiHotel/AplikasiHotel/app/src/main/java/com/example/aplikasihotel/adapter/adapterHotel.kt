package com.example.aplikasihotel.adapter
...
import com.example.aplikasihotel.R
import com.example.aplikasihotel.data.hotel

// Kelas adapter untuk RecyclerView dengan tampilan GridLayoutManager
class adapterHotel(private val hotelList: List<hotel>) : RecyclerView.Adapter<adapterHotel.PlayerViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.hotel, parent, false)

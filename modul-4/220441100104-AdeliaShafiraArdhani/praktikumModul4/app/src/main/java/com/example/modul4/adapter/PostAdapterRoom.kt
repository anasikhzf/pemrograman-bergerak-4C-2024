...
class PostAdapterRoom(private var postList: List<PostDatabase>) :
    ...
    class PostViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val postTitle: TextView = itemView.findViewById(R.id.judul)
        val postDesc: TextView = itemView.findViewById(R.id.description)
    ...
    override fun onCreateViewHolder(
        ...
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.activity_detail_post, parent, false)

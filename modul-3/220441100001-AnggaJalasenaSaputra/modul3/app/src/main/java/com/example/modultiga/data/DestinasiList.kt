...
object DestinasiList {
    val LokasiDum = arrayListOf(
        ...
        LocationData(
            "Goa Lawa",
            "Goa Lawa merupakan salah satu objek wisata di Trenggalek yang patut anda kunjungi. sejak diresmikannya menjadi objek wisata pada tahun 1984, Gua Lowo atau dalam bahasa jawanya gua kelelawar telah dikunjungi oleh puluhan ribu pengunjung. Sampai sekarang, goa yang terkenal sebagai goa terbesar dan terpanjang di asia tenggara ini masih menyimpan sejuta misteri.",
            "Trenggalek",
            R.drawable.goalawa
        ),
        LocationData(
            "Pantai Karanggongso",
            "Pantai ini berjarak 38 Km dari pusat kota Trenggalek. Dengan waktu tempuh sekitar 1 jam perjalanan. Dan hanya berjarak 3 km dari Pantai Prigi yang terkenal dengan pasir putihnya.\n" +
                    "\n" +
                    "Destinasi wisata pantai cantik ini menawarkan pemandangan pantai dengan pasir putih yang lembut. Lingkungan pantai yang bersih dengan suasana yang asri. Disepanjang pantai tumbuh rimbun pohon-pohon yang menambah kesejukan udara pantai di siang hari.",
            "Trenggalek",
            R.drawable.karanggongso
        ),
        LocationData(
            "Pantai Prigi",
    ...
    val HotelDum = arrayListOf(
        HotelData(
            ...
            50,
            5.0,
            "Ubud’s Hotel menawarkan akomodasi di Trenggalek dan berjarak sejauh 1 km dari Stadion Menak Sopal Trenggalek. Properti ini memiliki Wi-Fi gratis.\n" +
        ...
        HotelData(
            ...
            50,
            5.0,
            "Bukit Jaas Permai Hotel adalah tempat bermalam yang tepat bagi Anda yang berlibur bersama keluarga. Nikmati segala fasilitas hiburan untuk Anda dan keluarga.\n" +
                    "\n" +
                    "Pelayanan memuaskan serta fasilitas hotel yang memadai akan membuat Anda nyaman berada di Bukit Jaas Permai Hotel.\n" +
                    "\n" +
                    ...
                    "\n" +
                    "Bukit Jaas Permai Hotel adalah akomodasi dengan fasilitas baik dan kualitas pelayanan memuaskan menurut sebagian besar tamu.\n" +
                    "\n" +
                    "Dengan fasilitas yang memadai, Bukit Jaas Permai Hotel menjadi pilihan yang tepat untuk menginap. ",
            R.drawable.h2
        ),
        HotelData(
            "Ubud’s Hotel",
        ...
        HotelData(
            ...
            50,
            5.0,
            "Ubud’s Hotel homestay yang terletak di Jl. Moh Yamin Sawahan Sumber Gedong trenggalek, dengan total 21 kamar, memiliki beberapa fasilitas, antara lain - Parkir area - Waterheater - Wifi - Televisi - Laundry service dan masih banyak lainnya. Dekat dengan tempat wisata trenggalek, dan cocok untuk kebutuhan bisnis atau berlibur anda. ",
            R.drawable.griyaanggrek
        ),
        HotelData(
            "OYO 2966 Hotel Atriaz",
            39,
            4.7,
            "OYO 2966 Hotel Atriaz menawarkan kamar dengan tempat tidur yang nyaman untuk waktu menginap yang menyenangkan. Kamar dilengkapi dengan tempat tidur yang nyaman, wifi, AC, Televisi, kamar mandi yang higienis, dan perelengkapan dengan kualitas tinggi dan masa kini.",
            R.drawable.atriaz
        ),
        HotelData(

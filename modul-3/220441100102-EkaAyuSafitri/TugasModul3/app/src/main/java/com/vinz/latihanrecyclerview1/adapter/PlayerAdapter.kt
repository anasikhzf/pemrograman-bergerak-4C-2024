...
class PlayerAdapter(private val playerList: ArrayList<HotelData>) : RecyclerView.Adapter<PlayerAdapter.PlayerViewHolder>() {
    ...
    class PlayerViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        val playerName: MaterialTextView = itemView.findViewById(R.id.hotel_name)
        val playerDescription: MaterialTextView = itemView.findViewById(R.id.hotel_description)
        val playerImage: ShapeableImageView = itemView.findViewById(R.id.hotel_image)
    }
    ...
    override fun onBindViewHolder(holder: PlayerViewHolder, position: Int) {
        ...
        holder.playerName.text = data.hotelName
